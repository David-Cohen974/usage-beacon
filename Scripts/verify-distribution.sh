...
rg -q 'sparkle:edSignature=' "$appcast_path"
rg -q 'sparkle-signatures:' "$appcast_path"
rg -q "<sparkle:shortVersionString>$version</sparkle:shortVersionString>|sparkle:shortVersionString=\"$version\"" "$appcast_path"
